<%-- 
    Document   : PaiementImportCsv
    Created on : May 14, 2024, 7:00:36 PM
    Author     : fenor
--%>
...
<html>
    ...
    <body>
        <div class="page" id="page">
            ...
            <section class="save">
                <form id="formData" method="POST" action="upload-file-data-paiement" enctype="multipart/form-data" >
                    <h1>Import Donnée de Paiment Devis</h1>
                    <style>  
                         @keyframes error {
                                0% {
                    ...
                    <div class="drop-zone-section">
                        ...
                        <span class="drop-title">Drag file Paiement</span>
                        or
                        <input type="file" multiple id="images" name="paiement" accept=".csv" required>
                        </label>
                    </div>
